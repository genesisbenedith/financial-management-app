...
public class AllTests {
    ...
    public void testgetTotalSpentandAddRemoveExpense(){
        ...
        Expense expense = new Expense(Calendar.getInstance().set(2024, 12, 1), Category.FOOD, 80.71, "Panera Catering");
    ...
    public void testgetPercentageandisExceeded(){
        ...
        Expense expense = new Expense(Calendar.getInstance().set(2022, 8, 14), Category.HEALTHCARE, 768.64, "Covid Vaccine and Check up");
        Expense expense2 = new Expense(Calendar.getInstance().set(2022, 10, 1), Category.HEALTHCARE, 61.11, "Covid Vaccine and Check up");
    ...
    public void testToString(){
        ...
        assertEquals("Transportation, 7500.0");
    }
    ...
    public void testgetDateandDescription(){
        Calendar date = Calendar.getInstance().set(2024, 1, 1);
    ...
    public void testgetCategoryandAmount(){
        Calendar date = Calendar.getInstance().set(2018, 7, 21);
    ...
    public void testStrings(){
        Calendar date = Calendar.getInstance().set(2021, 6, 4);
